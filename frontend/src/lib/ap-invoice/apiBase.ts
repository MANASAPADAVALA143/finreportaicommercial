 ...
 * Dev: leave VITE_API_URL unset â†’ `/api/agent/...` is proxied by Vite to localhost:8000.
 * Vercel prod: leave VITE_API_URL unset â†’ browser POSTs same-origin `/api/agent/extract-image`,

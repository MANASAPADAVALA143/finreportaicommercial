...
const navigation: NavItem[] = [
  ...
  { name: 'ðŸ§  Training Data', href: '/training', icon: Brain },
  { name: 'âš¡ Anomaly Intelligence', href: '/anomaly-intelligence', icon: Brain },
];
...
const caFirmNav: NavItem[] = [
  ...
  { name: 'TB â†’ Financials', href: '/ca-firm/tb-financials', icon: FileSpreadsheet },
...
export function Layout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {/* Sidebar â€” top:36px accounts for the 36px Gnanova banner */}
      <div
        style={{ top: 36 }}
        className={cn(
      ...
      <div className="lg:pl-64">
        {/* Mobile header */}
        <div className="sticky top-9 z-10 flex h-16 items-center gap-4 border-b border-gray-200 bg-white px-4 lg:hidden">
          <button
          ...
          <h1 className="text-lg font-semibold text-gray-900">InvoiceFlow</h1>
        </div>

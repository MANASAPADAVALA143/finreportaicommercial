...
import { BarChart3, FileCheck, Zap, Target, Upload, Brain, LayoutGrid } from 'lucide-react';
...
export const Dashboard = () => {
    ...
    const modules = [
        {
            icon: _jsx(FileCheck, { className: "w-16 h-16 text-blue-400" }),
        ...
        },
        {
            ...
            description: '7-model client-specific anomaly detection — Amount, Duplicate, User, Timing, Account, Vendor, Benford',
            link: '/r2r-pattern',

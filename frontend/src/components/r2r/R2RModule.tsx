      ...
      <div className="container mx-auto max-w-7xl">
        ...
        {results.length > 0 && (
          <>
            ...
            {/* Amazon Nova AI Classification Metrics */}
            {metrics && (
              <div className="bg-white rounded-2xl shadow-xl border border-gray-100 p-8 mb-8">
                <div className="flex items-center gap-3 mb-6">
                  <BarChart3 className="w-6 h-6 text-purple-600" />
                  <div>
                    <h3 className="text-xl font-bold text-gray-900">Amazon Nova AI Classification Metrics</h3>
                    <p className="text-sm text-gray-600">ML model performance analysis</p>
                  </div>
                </div>
                
                <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                  <div className="text-center bg-blue-50 rounded-xl p-6">
                    <p className="text-sm font-medium text-blue-700 mb-2">Accuracy</p>
                    <p className="text-4xl font-bold text-blue-600">{metrics.accuracy}%</p>
                    <p className="text-xs text-blue-600 mt-2">Overall correctness</p>
                  </div>
                  <div className="text-center bg-green-50 rounded-xl p-6">
                    <p className="text-sm font-medium text-green-700 mb-2">Precision</p>
                    <p className="text-4xl font-bold text-green-600">{metrics.precision}%</p>
                    <p className="text-xs text-green-600 mt-2">True positive rate</p>
                  </div>
                  <div className="text-center bg-violet-50 rounded-xl p-6">
                    <p className="text-sm font-medium text-violet-700 mb-2">Recall</p>
                    <p className="text-4xl font-bold text-violet-600">{metrics.recall}%</p>
                    <p className="text-xs text-violet-600 mt-2">Detection rate</p>
                  </div>
                  <div className="text-center bg-cyan-50 rounded-xl p-6">
                    <p className="text-sm font-medium text-cyan-700 mb-2">F1 Score</p>
                    <p className="text-4xl font-bold text-cyan-600">{metrics.f1Score}%</p>
                    <p className="text-xs text-cyan-600 mt-2">Harmonic mean</p>
                  </div>
                </div>
                ...
                {confusionMatrix && (
                  <div className="mt-8 bg-gray-50 rounded-xl p-6">
                    <h4 className="text-sm font-semibold text-gray-700 mb-4">Confusion Matrix</h4>
                    <div className="grid grid-cols-2 gap-4 max-w-md mx-auto">
                      <div className="bg-green-100 rounded-lg p-4 text-center">
                        <p className="text-xs text-green-700 mb-1">True Positive</p>
                        <p className="text-2xl font-bold text-green-800">{confusionMatrix.truePositive}</p>
                      </div>
                      <div className="bg-red-100 rounded-lg p-4 text-center">
                        <p className="text-xs text-red-700 mb-1">False Positive</p>
                        <p className="text-2xl font-bold text-red-800">{confusionMatrix.falsePositive}</p>
                      </div>
                      <div className="bg-yellow-100 rounded-lg p-4 text-center">
                        <p className="text-xs text-yellow-700 mb-1">False Negative</p>
                        <p className="text-2xl font-bold text-yellow-800">{confusionMatrix.falseNegative}</p>
                      </div>
                      <div className="bg-blue-100 rounded-lg p-4 text-center">
                        <p className="text-xs text-blue-700 mb-1">True Negative</p>
                        <p className="text-2xl font-bold text-blue-800">{confusionMatrix.trueNegative}</p>
                      </div>
                    </div>
                  </div>
                )}

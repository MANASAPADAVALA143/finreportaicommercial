...
export async function generateNoteContent(noteType, financialData, companyInfo) {
...
function getFallbackNoteContent(noteType, company, data) {
    ...
    for (const [k, v] of Object.entries(fallbacks)) {
        if (key.includes(k) || noteType.toLowerCase().includes(k))
            return v;
    }
...
const NOTE_TYPE_TO_SERVICE_KEY = {
...
export function getNoteTypeForGeneration(sectionId) {

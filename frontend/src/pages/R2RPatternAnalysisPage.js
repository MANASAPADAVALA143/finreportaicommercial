...
// ─── Tab: AI Insights ─────────────────────────────────────────────────────────
const AIInsightsTab = ({ data }) => (_jsxs("div", { style: { display: "flex", flexDirection: "column", gap: 20 }, children: [_jsxs(Card, { style: { borderLeft: `4px solid ${C.blue}` }, children: [_jsxs("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: 16 }, children: [_jsxs("div", { children: [_jsxs("div", { style: { fontSize: 14, fontWeight: 700, color: C.text, display: "flex", alignItems: "center", gap: 6 }, children: ["\uD83E\uDD16 AI Pattern Summary ", _jsx("span", { style: { fontSize: 11, color: C.textSub, fontWeight: 400 }, children: "LLM-assisted" })] }), _jsxs("div", { style: { fontSize: 12, color: C.textSub, marginTop: 2 }, children: ["Generated ", new Date().toLocaleDateString(), " \u00B7 ", data.total, " JEs analysed \u00B7 ", data.high, " HIGH risk flagged"] })] }), _jsx(Badge, { label: "87% Confidence", color: "green" })] }), [

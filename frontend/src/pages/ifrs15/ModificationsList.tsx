...
import { Button, Ifrs15WorkspaceShell, SidebarLayout, getCurrentFirmId } from './ifrs15PortShims';
import { ifrs15Api } from '../../services/ifrs15Extended.service';
              ...
              return (
                ...
                >
                  ...
                  <div className="flex items-center gap-2 justify-end">
                    ...
                    <Link
                      to={`/r2r/rev-rec/modifications/${r.id}`}
                      ...
                      <div className="flex flex-wrap gap-2">
                        ...
                        <Button
                          ...
                          onClick={() => {
                            ...
                            setPanelOpen(false);
                            navigate(`/r2r/rev-rec/modifications/${result.id}`);
                          }}
                        >
                          Save Draft
                        </Button>

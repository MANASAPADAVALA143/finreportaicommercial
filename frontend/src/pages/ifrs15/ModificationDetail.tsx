...
import { Button, Ifrs15WorkspaceShell, SidebarLayout } from './ifrs15PortShims';
    ...
    <SidebarLayout pageTitle="Modification detail" pageSubtitle="IFRS 15.18–21 workpaper">
      <Ifrs15WorkspaceShell activeNavId="contract-modifications" kpiItems={kpiItems}>
        <div className="flex items-center justify-between gap-2">
          <div>
            <Link to="/r2r/rev-rec/modifications" className="text-xs text-[#f97316] font-semibold hover:underline">
              ← All modifications
            </Link>

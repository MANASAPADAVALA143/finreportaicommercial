...
export default function GulfTaxDashboard() {
  ...
  return (
    <>
      ...
      <div className="mb-7 rounded-2xl border border-border bg-gradient-to-br from-card to-[#071228] overflow-hidden">
        <div className="px-6 py-4 border-b border-border">
          <div className="text-sm font-semibold text-white">VAT Advanced Tools</div>
          <p className="text-[11px] text-muted2 mt-1">Partial exemption, Designated Zones, and bad debt relief</p>
        </div>
        <div className="grid sm:grid-cols-3 divide-y sm:divide-y-0 sm:divide-x divide-border">
          <Link
            to="/gulftax/partial-exemption"
            className="px-6 py-5 hover:bg-white/5 transition-colors block"
          >
            <div className="text-lg mb-1">🧮</div>
            <div className="text-sm font-medium text-white">Partial Exemption</div>
            <div className="text-[11px] text-muted2 mt-1">Pro-rata input VAT recovery</div>
          </Link>
          <Link
            to="/gulftax/designated-zones"
            className="px-6 py-5 hover:bg-white/5 transition-colors block"
          >
            <div className="text-lg mb-1">📍</div>
            <div className="text-sm font-medium text-white">Designated Zones</div>
            <div className="text-[11px] text-muted2 mt-1">Goods vs services VAT rules</div>
          </Link>
          <Link
          ...
          >
            <div className="text-lg mb-1">📋</div>
            <div className="text-sm font-medium text-white">Bad Debt Relief</div>
            <div className="text-[11px] text-muted2 mt-1">
              {pendingBadDebt > 0
                ? `Pending claims: AED ${pendingBadDebt.toLocaleString('en-AE', { minimumFractionDigits: 2 })}`
                : '6-month overdue VAT recovery'}
            </div>
          </Link>
        </div>
      </div>

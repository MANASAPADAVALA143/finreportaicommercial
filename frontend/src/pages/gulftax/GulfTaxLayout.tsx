...
import {
  ...
  Calculator, MapPin, FileWarning, Shield, ShieldCheck, Radar, FileSpreadsheet,
} from 'lucide-react';
...
const INTELLIGENCE_NAV: NavItem[] = [
  ...
  { to: '/gulftax/anomaly-detection', label: 'Anomaly Detection', icon: Radar },
  { to: '/gulftax/tax-compliance', label: 'Tax Compliance Report', icon: ShieldCheck },
  { to: '/gulftax/recon-summary', label: 'Reconciliation Summary', icon: GitMerge },
  { to: '/gulftax/financial-statements', label: 'Financial Statements', icon: FileSpreadsheet },
];

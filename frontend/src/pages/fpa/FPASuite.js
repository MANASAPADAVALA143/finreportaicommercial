...
export const FPASuite = () => {
    ...
    return (_jsxs("div", { className: "min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-slate-50", children: [_jsx(MultiUploadModal, { isOpen: showUploadModal, onClose: () => setShowUploadModal(false) }), _jsx("div", { className: "bg-white border-b border-gray-200 shadow-sm", children: _jsxs("div", { className: "max-w-7xl mx-auto px-6 py-6", children: [_jsxs("div", { className: "flex items-center justify-between mb-4", children: [_jsxs("div", { className: "flex items-center gap-4", children: [_jsx("button", { onClick: () => navigate('/dashboard'), className: "p-2 hover:bg-gray-100 rounded-lg transition", children: _jsx(ArrowLeft, { className: "w-5 h-5 text-gray-600" }) }), _jsxs("div", { children: [_jsx("h1", { className: "text-3xl font-bold text-gray-900", children: "FP&A Suite" }), _jsx("p", { className: "text-gray-600 mt-1", children: "Financial Planning & Analysis Tools" })] })] }), _jsxs("button", { type: "button", onClick: () => setShowUploadModal(true), className: "flex items-center gap-2 px-4 py-2 rounded-lg transition-colors shadow-sm bg-blue-600 text-white hover:bg-blue-700", children: [_jsx(Upload, { className: "w-4 h-4" }), _jsx("span", { children: "Upload Data" })] })] }), _jsx("div", { className: "bg-gradient-to-r from-blue-50 to-purple-50 border border-blue-200 rounded-lg p-4 mt-4", children: _jsxs("p", { className: "text-sm text-blue-900", children: [_jsx("strong", { children: "\uD83D\uDCA1 Upload here for FP&A:" }), " Upload your trial balance in this section; the modules below use only data you upload in FP&A Suite."] }) }), _jsxs("div", { className: "flex items-center gap-6 text-sm mt-4", children: [_jsxs("div", { className: "flex items-center gap-2", children: [_jsx(CheckCircle, { className: "w-4 h-4 text-green-600" }), _jsxs("span", { className: "text-gray-700", children: [_jsx("span", { className: "font-semibold", children: "7" }), " modules active"] })] }), _jsxs("div", { className: "flex items-center gap-2", children: [_jsx(Clock, { className: "w-4 h-4 text-gray-400" }), _jsxs("span", { className: "text-gray-700", children: [_jsx("span", { className: "font-semibold", children: "FP&A Suite Complete!" }), " \uD83C\uDF89"] })] })] })] }) }), _jsxs("div", { className: "max-w-7xl mx-auto px-6 py-8", children: [_jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6", children: modules.map((module, index) => {

 ...
 */
export function calculateScenario(assumptions, baseline = DEFAULT_BASELINE) {
    // ========================================
 ...
 */
export function calculateMonthlyProjections(assumptions, baseline = DEFAULT_BASELINE) {
 ...
 */
export function calculateSensitivity(baseAssumptions, baseline = DEFAULT_BASELINE) {
    ...
    return variables.map(variable => {
        ...
        const sensitivity = impact > 50000000 ? 'high' :

...
export const heatmapData = [
    ...
    ...['Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun', 'Jul', 'Aug', 'Sep', 'Oct'].map((month, idx) => ({
        ...
        month,
        status: ['good', 'good', 'warning', 'good', 'warning', 'critical', 'good', 'warning', 'warning', 'critical'][idx],
    ...
    ...['Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun', 'Jul', 'Aug', 'Sep', 'Oct'].map((month, idx) => ({
        ...
        month,
        status: ['good', 'warning', 'good', 'good', 'critical', 'warning', 'good', 'good', 'warning', 'critical'][idx],
    ...
    ...['Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun', 'Jul', 'Aug', 'Sep', 'Oct'].map((month, idx) => ({
        kpiName: 'Net Margin',
        month,
        status: ['warning', 'good', 'good', 'warning', 'warning', 'critical', 'warning', 'good', 'critical', 'critical'][idx],
    ...
    ...['Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun', 'Jul', 'Aug', 'Sep', 'Oct'].map((month, idx) => ({
        kpiName: 'Cash Ratio',
        month,
        status: ['good', 'good', 'good', 'warning', 'warning', 'warning', 'good', 'warning', 'warning', 'warning'][idx],
    ...
    ...['Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun', 'Jul', 'Aug', 'Sep', 'Oct'].map((month, idx) => ({
        kpiName: 'DSO',
        month,
        status: ['good', 'good', 'warning', 'warning', 'critical', 'warning', 'warning', 'critical', 'warning', 'warning'][idx],

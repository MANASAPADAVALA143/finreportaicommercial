import { ReportHistory, BoardPackSection, FlashReportData } from '../types/reports';
...
export const boardPackSections: BoardPackSection[] = [
...
export const flashReportData: FlashReportData = {

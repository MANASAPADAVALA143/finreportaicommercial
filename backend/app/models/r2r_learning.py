...
class R2RHistoricalEntry(Base):
    """Per-company historical JE baseline — synced from accounting on every Post."""
    __tablename__ = "r2r_historical_data"

    id           = Column(Integer, primary_key=True, autoincrement=True)
    company_id   = Column(String(128), nullable=False, index=True)
    country      = Column(String(10),  nullable=False, default="UAE")
    ...
    account_code = Column(String(20),  nullable=True, index=True)
